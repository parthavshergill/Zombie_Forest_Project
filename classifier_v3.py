...
species_counts['conifer_class'] = label_encoder.fit_transform(species_counts['conifer_class'])

# Step 4: Split the data into training and testing sets
X = species_counts.drop(columns=['conifer_class'])
y = species_counts['conifer_class']
