...
presence_absence['conifer_class'] = label_encoder.fit_transform(presence_absence['conifer_class'])

# Step 4: Split the data into training and testing sets
X = presence_absence.drop(columns=['conifer_class'])
y = presence_absence['conifer_class']
