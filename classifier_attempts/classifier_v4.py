'''
Log. Regression, Random Forest, XGBoost on composite_zf_class with class imbalance adjustment
'''
...
# XGBoost Classifier
clf_xgb = XGBClassifier(scale_pos_weight=len(y_train_balanced[y_train_balanced == 0]) / len(y_train_balanced[y_train_balanced != 0]), random_state=42)
